...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_traffic4_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_traffic4_error # File name for error
