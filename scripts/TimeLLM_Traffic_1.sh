...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_traffic1_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_traffic1_error # File name for error
