...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_etth2_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_etth2_error # File name for error
