...
#SBATCH -o /project/msun/xchen87/timellm_log/few_shot_synonymous_anchors_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/few_shot_synonymous_anchors_error # File name for error
