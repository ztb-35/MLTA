...
#SBATCH -o /project/msun/xchen87/timellm_log/few_shot_align_residual_only_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/few_shot_align_residual_only_error # File name for error
