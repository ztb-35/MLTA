...
#SBATCH -o /project/msun/xchen87/timellm_log/few_shot_no_task_intro_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/few_shot_no_task_intro_error # File name for error
