...
#SBATCH -o /project/msun/xchen87/timellm_log/few_shot_no_domain_feature_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/few_shot_no_domain_feature_error # File name for error
