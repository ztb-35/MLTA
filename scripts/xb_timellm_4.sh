...
#SBATCH -o /project/tzhao3/Time-LLM-main/job/etth1_out_4 # File name for stdout
#SBATCH -e /project/tzhao3/Time-LLM-main/job/etth1_error_4 # File name for error
#SBATCH --mail-type END # Send email when job ends
#SBATCH --mail-user tzhao3@lsu.edu # Send mail to this address
#SBATCH --gres=gpu:4
#job on super mike3, xiaobing job script for baseline TimeLLM on ETTm1
