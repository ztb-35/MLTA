...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_weather_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_weather_error # File name for error
