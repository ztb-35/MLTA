...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_traffic3_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_traffic3_error # File name for error
