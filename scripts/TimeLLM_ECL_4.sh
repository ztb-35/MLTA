...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_ecl_out_4 # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_ecl_error_4 # File name for error
