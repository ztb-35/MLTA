...
#SBATCH -o /project/msun/xchen87/timellm_log/timellm_ettm1_out # File name for stdout
#SBATCH -e /project/msun/xchen87/timellm_log/timellm_ettm1_error # File name for error
